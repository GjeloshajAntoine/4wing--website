...
<!-- Titre de la page -->
  <div class="container projet " id="titreSante">
    <div class="row" >
      <div class="col-sm-12"> <span class="icon-home-outline"></span>

        <h1>Titre projet Santé et Nutrition</h1>
      </div>
    </div>
  </div>
<!-- Fin titre de la page -->
 ...
 <!-- Partie haute bleue -->
<div class="projetSante  pageProjet" >
  
  <div class="container" id="introSante">

    <div class="row">

        <div class=" col-md-4 col-sm-12">
          <div class="vignette">"><img src="../img/vignette-sante.jpg" alt="logo becode"></div>
            <p class="introSante">
...
<!-- Titre de la page -->
<div class="container projet" id="texteSante">
      <div class="row" >
          <div class="col-sm-12">
